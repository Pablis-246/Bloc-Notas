...
export const singup = async (req, res) => {
  ...
  if (errors.length > 0) {
    ...
    if (emailUser) {
      req.flash("error_msg", "El correo electronico ingresado ya esta en uso.");
      ...
      await newUser.save();
      req.flash("success_msg", "Te has registraste correctamente.");
...
export const logout = (req, res) => {
  req.logout();
  req.flash("success_msg", "Cerraste la sesión de tu cuenta correctamente.");
  res.redirect("/users/signin");
};
